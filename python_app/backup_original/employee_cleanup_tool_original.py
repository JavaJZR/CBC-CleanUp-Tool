...
4️⃣ EXPORT RESULTS: Download enriched data (with PERNRs, Full Names, Resignation Dates, and Organizational Data) and unmatched records
    ...
    def cleanup_worker(self):
        ...
        try:
                ...
                if has_previous_reference and user_id_current and user_id_previous and pernr_previous:
                    ...
                    if pd.notna(user_id):
                        ...
                        if not match.empty:
                            ...
                            if self.is_valid_pernr(pernr_value):
            ...
            self.cleaned_data = current_df.copy()
    ...
    def is_valid_pernr(self, pernr_value):
        """
    ...
    def show_results_section(self):
        ...
        tk.Label(
            cleaned_frame,
            text=f"All {total} records (matched + unmatched) with enriched data where available",
            font=("Arial", 8),
            bg="white",
            fg="#6b7280"
        ).pack()
