  ...
  return (
    <div className="space-y-4 bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-blue-100 shadow-lg">
      <div className="flex items-center justify-between">
        <h3 className="text-2xl font-black bg-gradient-to-r from-[#CD1C18] to-[#9B1313] bg-clip-text text-transparent tracking-tight">{title}</h3>
      ...
      <p className="text-lg text-gray-900 font-bold">
        Showing <strong className="text-[#CD1C18] font-black">{displayData.length}</strong> of <strong className="text-[#CD1C18] font-black">{filteredData.length}</strong> rows
      </p>
    </div>
  );
}